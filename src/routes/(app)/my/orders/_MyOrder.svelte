	...
	{#if data.orders.length}
		<div>
			<header class="mb-5 flex flex-wrap items-start justify-between gap-4">
				<h1>
					Orders {#if data.count}({data.count}){/if}
				</h1>
							...
							<tbody
								...
								{#each order.items as item}
									...
									<tr>
										...
										<td class="whitespace-nowrap p-3">
											{currency(item.unit_price / 100, order.currency_code.toUpperCase())}
										</td>

										<td class="whitespace-nowrap p-3">
												RM 0.00
											<!-- {currency(item.shipping_total / 100, order.currency_code.toUpperCase())} -->
										</td>

										<td class="whitespace-nowrap p-3">
											{currency(item.total / 100, order.currency_code.toUpperCase())}
										</td>
								...
								<tr class="row-total">
									<td class="p-3">
										<div class="shrink-0 text-lg text-black font-bold">
											TOTAL
										</div>
									</td>
									...
									<td class="whitespace-nowrap p-3">
										...
										{currency(order.shipping_total / 100, order.currency_code.toUpperCase())}
									</td>

									<td class="whitespace-nowrap p-3">
										{currency(order.total / 100, order.currency_code.toUpperCase())}
									</td>
									...
									<div class="w-full flex-1">
										...
										<div class="flex flex-wrap gap-2">
											...
											<!-- <div class="flex items-center gap-2">
												...
												<b>
													{currency(item.tax_total / 100, order.currency_code.toUpperCase())}
												</b>
											</div> -->
									...
									<div class="w-full flex-1">
										...
										<div class="flex flex-wrap gap-2">
											<div class="flex items-center gap-2">
												...
												<b>
													{currency(order.subtotal / 100, order.currency_code.toUpperCase())}
			...
			<!-- <Pagination
				count="{Math.ceil((data.count || 1) / orders.pageSize)}"
