				...
				<ul class="mx-auto mb-5 flex max-w-max flex-col gap-2 sm:mb-10">
					...
					<!-- <li>
						<p class="flex items-start gap-2">
							...
							<span class="uppercase" class:text-brand-500="{data.order?.status === 'paid'}">
								: &nbsp; {data.order?.status}
							</span>
						</p>
					</li> -->
											...
											<div class="w-4/5 flex-1 lg:w-10/12">
												...
												<div class="mb-2 flex w-full flex-wrap gap-4">
													...
													<p class="flex items-center gap-2 whitespace-nowrap">
														...
														<span>{currency(item.unit_price / 100, data.order.currency_code.toUpperCase())}</span>
													</p>
												</div>
					...
					{#if data.order && data.order?.shipping_address}
						<div class="text-sm">
							...
							<div class="flex flex-col gap-1">
								...
								<p>
									{#if data.order?.shipping_address.address_1}
									...
									{#if data.order?.shipping_address.country_code}
										, {data.order?.shipping_address.country_code}
									{/if}

									{#if data.order?.shipping_address.postal_code}
							...
							<div class="flex max-w-max flex-col items-start gap-2">
								{#if data.order?.subtotal}
									<p class="flex items-center">
										...
										<span>
											: &nbsp; {currency(
												data.order?.subtotal / 100,
												data.order.currency_code.toUpperCase()
											)}
										</span>
									</p>
								{/if}
								...
								{#if data.order?.shipping_total}
									<p class="flex items-center">
										<span class="mr-2 w-20">Shipping</span>

										<span>
											: &nbsp; {currency(
												data.order?.shipping_total / 100,
												data.order.currency_code.toUpperCase()
											)}
										</span>
									</p>
