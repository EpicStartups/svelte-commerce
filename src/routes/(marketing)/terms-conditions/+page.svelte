		...
		<ul class="flex flex-col gap-5 text-justify text-sm sm:text-base">
			<li>
				...
				<p class="text-zinc-500">
					Welcome to our online store! Shopolah and its associates provide their
			...
			<li>
				...
				<p class="text-zinc-500">
					When you visit Shopolah or send e-mails to us, you are communicating
			...
			<li>
				...
				<p class="text-zinc-500">
					...
					audio clips, digital downloads, data compilations, and software, is the property of Shopolah
					or its content suppliers and protected by international copyright laws. The compilation of
					all content on this site is the exclusive property of Shopolah,
					with copyright authorship for this collection by Shopolah, and
			...
			<li>
				...
				<p class="text-zinc-500">
					Shopolah’s trademarks and trade dress may not be used in connection
					with any product or service that is not Shopolah’s, in any manner
					that is likely to cause confusion among customers, or in any manner that disparages or
					discredits Shopolah. All other trademarks not owned by Shopolah or its subsidiaries that appear on this site are the property of their
					respective owners, who may or may not be affiliated with, connected to, or sponsored by
					Shopolah or its subsidiaries.
				</p>
			</li>
			...
			<li>
				...
				<p class="text-zinc-500">
					Shopolah grants you a limited license to access and make personal use
					of this site and not to download (other than page caching) or modify it, or any portion of
					it, except with express written consent of Shopolah. This license
					...
					express written consent of Shopolah. You may not frame or utilize
					framing techniques to enclose any trademark, logo, or other proprietary information
					(including images, text, page layout, or form) of Shopolah and our associates
					without express written consent. You may not use any meta tags or any other “hidden text” utilizing
					Shopolah’s name or trademarks without the express written consent
					of Shopolah. Any unauthorized use terminates the permission or
					license granted by Shopolah. You are granted a limited, revocable,
					and nonexclusive right to create a hyperlink to the home page of Shopolah
					so long as the link does not portray Shopolah, its associates, or
					their products or services in a false, misleading, derogatory, or otherwise offensive
					matter. You may not use any
					Shopolah logo or other proprietary graphic or trademark as part of the
			...
			<li>
				...
				<p class="text-zinc-500">
					...
					under 18, you may use our website only with involvement of a parent or guardian. Shopolah
			...
			<li>
				...
				<p class="text-zinc-500">
					...
					Shopolah reserves the right (but not the obligation) to remove or edit
					such content, but does not regularly review posted content. If you do post content or submit
					material, and unless we indicate otherwise, you grant Shopolah and its
					...
					and display such content throughout the world in any media. You grant Shopolah and its associates and sub-licensees the right to use the name that you submit
					...
					any person or entity: and that you will indemnify Shopolah
					or its associates for all claims resulting from content you supply. Shopolah has the right but not the obligation to monitor and edit or remove any activity
					or content. Shopolah
			...
			<li>
				...
				<p class="text-zinc-500">
					All items purchased from Shopolah are made pursuant to a shipment contract.
			...
			<li>
				...
				<p class="mb-5 text-zinc-500">
					Shopolah and its associates attempt to be as accurate as possible. However,
					Shopolah
				...
				<p class="text-zinc-500">
					Disclaimer of warranties and limitation of liability this site is provided by Shopolah
					on an “as is” and “as available” basis. Shopolah makes no representations
					...
					this site is at your sole risk. to the full extent permissible by applicable law, Shopolah
					disclaims all warranties, express or implied, including, but not limited to, implied warranties
					of merchant-ability and fitness for a particular purpose. Shopolah does
					not warrant that this site, its servers, or e-mail sent from Shopolah are free of viruses or other harmful components. Shopolah will not be liable for any damages of any kind arising from the use of this
			...
			<li>
				...
				<p class="text-zinc-500">
					By visiting Shopolah, you agree that the laws of the state of
					ODISHA, INDIA, without regard to principles of conflict of laws, will govern these
					Conditions of Use and any dispute of any sort that might arise between you and Shopolah or its associates.
				</p>
			</li>
			...
			<li>
				...
				<p class="text-zinc-500">
					Any dispute relating in any way to your visit to Shopolah or to products
					you purchase through
					Shopolah shall be submitted to confidential arbitration in Odisha, India,
					except that, to the extent you have in any manner violated or threatened to violate
					Shopolah’s intellectual property rights, Shopolah may seek injunctive or other appropriate relief in any state or federal court
			...
			<li>
				...
				<p class="text-zinc-500">
					...
					site. These policies also govern your visit to Shopolah . We reserve
			...
			<li>
				...
				<p class="text-zinc-500">
					...
					side menu or in the footer. Or you can email us at: help@shopolah.com
				</p>
			</li>
		</ul>
	</div>
